...
from ..equipment import Equipment, Weapon, Armor, MagicItem
...
class BoltacShop:
    ...
    def __init__(self, save_dir: str = None):
        ...
        """
        if save_dir is None:
            # Try to get save path from tools.common if available
            try:
                ...
                home = str(Path.home())
                save_dir = os.path.join(home, 'Saved_Games_DnD_5th', 'shop')
    ...
    def load(self) -> bool:
        ...
        try:
            ...
            try:
                from ..equipment.magic_item_factory import MAGIC_ITEMS_REGISTRY
                from ..equipment.weapon_factory import SPECIAL_WEAPONS
                from ..equipment.armor_factory import SPECIAL_ARMORS
    ...
    def _initialize_default_stock(self):
        ...
        # 1. Add ALL magic items from MAGIC_ITEMS_REGISTRY
        from ..equipment.magic_item_factory import MAGIC_ITEMS_REGISTRY
