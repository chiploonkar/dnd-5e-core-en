...
**File:** `DnD-5th-Edition-API/HISTORIQUE_DEVELOPPEMENT.md`

**Full path:**
```
/Users/display/PycharmProjects/DnD-5th-Edition-API/HISTORIQUE_DEVELOPPEMENT.md
```
...
- **DnD-5e-ncurses** - Standalone ncurses version
