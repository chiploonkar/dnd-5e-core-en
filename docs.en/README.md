...
- **[COLLECTIONS_MIGRATION.md](COLLECTIONS_MIGRATION.md)** - Collections migration guide
- **[COLLECTIONS_COMPLETE.md](COLLECTIONS_COMPLETE.md)** - Complete migration summary
